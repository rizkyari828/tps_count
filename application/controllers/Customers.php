...
class Customers extends BaseController
{
    ...
    function customerListing()
    {
        ...
        {        
            ...
            $this->global['pageTitle'] = 'Quick Count Jateng : Customer Listing';
    ...
    function addNewCust()
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Quick Count Jateng : Add New Customer';
    ...
    function modifyCustomer($customerId = NULL)
    {
        ...
        else
        {
			...
			//exit;
            $this->global['pageTitle'] = 'Quick Count Jateng : Edit Customer';
    ...
    function viewCustomer($customerId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Quick Count Jateng : View Customer';
