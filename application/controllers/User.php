...
class User extends BaseController
{
    ...
    public function index()
    {
        ...
        $data['statusTps'] = $this->suara_model->statusTps();
    ...
    function userListing()
    {
        ...
        {        
            ...
            $this->global['pageTitle'] = 'Quick Count Jateng : User Listing';
    ...
    function addNew()
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Quick Count Jateng : Add New User';
    ...
    function modifyUser($userId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Quick Count Jateng : Edit User';
    ...
    {
        $this->global['pageTitle'] = 'Quick Count Jateng : 404 - Page Not Found';
    ...
    function loginHistoy($userId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Quick Count Jateng : User Login History';
    ...
    function profile($active = "details")
    {
        ...
        $this->global['pageTitle'] = $active == "details" ? 'Quick Count Jateng : My Profile' : 'Quick Count Jateng : Change Password';
