    ...
    <footer class="main-footer">
        <div class="pull-right hidden-xs">
          <b>Quick Count Jateng</b> CRM System | Version 1.0
        </div>
        <strong>Copyright &copy; <?php echo date("Y");?> <a href="<?php echo base_url(); ?>">Quick Count Jateng</a>.</strong> All rights reserved.
    </footer>
