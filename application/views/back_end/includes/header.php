...
<html>
  <head>
    ...
    <!-- //Dropdown muncul tp field disabled
    //color jadi RED -->
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="<?php echo base_url(); ?>" class="logo">
          ...
          <span class="logo-mini"><b>QC</b>&nbsp;Jateng</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Quick Count</b>&nbsp;Jateng</span>
        </a>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu" data-widget="tree">
           ...
           <!-- <li>
            ...
            ?>
            <li class="treeview">
              <a href="#"><span><i class="fa fa-car"></i>&nbsp;&nbsp;Manage Suara</span></a>
              <ul class="treeview-menu icon">
                <!-- <li><i class="fa fa-arrow-circle-right"></i>&nbsp;&nbsp;<a href="<?php echo base_url(); ?>vehicleListing">Vehicles Listing</a></li> -->
                <li><a href="<?php echo base_url(); ?>selectTps">Input Suara</a></li>
              </ul>
            </li>
          </ul>
        </section>
